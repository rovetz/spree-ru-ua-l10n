...
desc 'Generate documentation for the ru_ua_l10n extension.'
Rake::RDocTask.new(:rdoc) do |rdoc|
  rdoc.rdoc_dir = 'rdoc'
  rdoc.title    = 'RuUaL10nExtension'
...
desc 'Test the ru_ua_l10n extension.'
...
namespace :test do
  desc 'Functional test the ru_ua_l10n extension.'
  ...
  desc 'Unit test the ru_ua_l10n extension.'
